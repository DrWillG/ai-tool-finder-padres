        ...
        {phase === 'loading' && (
          ...
          >
            ...
            <div className="text-center">
              <p className="text-lg font-semibold text-gray-800">Buscando tus herramientas…</p>
              <p className="text-sm text-gray-400 mt-1">Verificando clasificaciones de seguridad y adecuación por edad</p>
            </div>
          </motion.div>
        )}
